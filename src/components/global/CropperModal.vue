          ...
          <div class="bg-white px-4 pt-5 pb-4 p-6">
            <div class="flex items-center">
              <div class="mt-3 text-left">
                ...
                <div class="pb-3 pt-5 flex flex-row reverse">
                  <button
                    v-if="uploadedImage"
                    @click="crop"
                    type="button"
                    class="inline-flex w-full justify-center rounded-md border border-transparent bg-green-600 px-4 py-2 text-white text-base font-medium shadow-sm hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 ml-3 w-auto text-sm"
                  >
                    Save
                  </button>
                  <button
